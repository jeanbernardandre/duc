<section class="cta">
    <div class="text-center">
        <a
            ...
            class="btn bkg-white <?php the_sub_field('cta_bg'); ?>"
            title=""
            target="<?php the_sub_field('cta_link_target'); ?>"
        >
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                 xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                 width="17.141px" height="11.422px" viewBox="0.792 0.789 17.141 11.422"
                 enable-background="new 0.792 0.789 17.141 11.422"
                 xml:space="preserve">
                    <path d="M17.897,6.686c0.012-0.063,0.035-0.123,0.035-0.186c0-0.063-0.023-0.122-0.034-0.184
